...
func (m *MockReleaser) Release(err error) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "Release", err)
}

// Release indicates an expected call of Release.
func (mr *MockReleaserMockRecorder) Release(err interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Release", reflect.TypeOf((*MockReleaser)(nil).Release), err)
}
